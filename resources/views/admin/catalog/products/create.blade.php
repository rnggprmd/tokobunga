            ...
            <div>
                ...
                <div class="flex gap-4">
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="radio" name="tipe_produk" value="ready" {{ old('tipe_produk', 'ready') == 'ready' ? 'checked' : '' }}
                            class="accent-accent-emerald">
                        <span class="text-sm">Ready Stock</span>
                    </label>
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="radio" name="tipe_produk" value="custom" {{ old('tipe_produk') == 'custom' ? 'checked' : '' }}
                            class="accent-accent-emerald">
